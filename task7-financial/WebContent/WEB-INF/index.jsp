	...
	<div class="row clearfix">
		<div class="col-md-3 column">
			<div class="panel-group" id="panel-872653">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-872653" href="#panel-element-704803">News & Insights</a>
					</div>
					<div id="panel-element-704803" class="panel-collapse collapse">
						<div class="panel-body">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-872653" href="#">Research</a>
					</div>
				</div>
				<div class="panel panel-default">
					<div class="panel-heading">
						 <a class="panel-title" data-toggle="collapse" data-parent="#panel-872653" href="#">Contact Us</a>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-9 column">
			<div class="carousel slide" id="carousel-237806">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-237806">
					</li>
					<li data-slide-to="1" data-target="#carousel-237806">
					</li>
					<li data-slide-to="2" data-target="#carousel-237806">
					</li>
				</ol>
